...
<div class="ba_popup_compare">
	<p style="margin: 0px;">{l s='Added to your compare, View comparison list' mod='baproductscarousel'} <a style="color: #00aff0" href="{$base|escape:'htmlall':'UTF-8'}{$iso_lang|escape:'htmlall':'UTF-8'}/products-comparison" class="clish2" target="_blank">{l s='click here' mod='baproductscarousel'}</a></p>
	<span class="ba_close_popup"><a title="{l s='Close' mod='baproductscarousel'}" class="fancybox-close exit_popup" href="javascript:;"></a></span>
</div>
	...
	{if $embe == 1}
		{if count($shows) > 0}
			...
			<div style="width: {$sizeslide->sliw|escape:'htmlall':'UTF-8'};height: {$sizeslide->slih|escape:'htmlall':'UTF-8'}" class="fadeOut_{$id_sl|escape:'htmlall':'UTF-8'} owl-carousel owl-theme saddd {if $bablocks == 'home page tab'}owl-hidden{/if}">
				...
				{addJsDefL name=added_to_wishlist}{l s='Added to your wishlist, view your wishlist ' mod='baproductscarousel'}<a class="clish2" style="color: #00aff0" href="{$base|escape:'htmlall':'UTF-8'}{$iso_lang|escape:'htmlall':'UTF-8'}/module/blockwishlist/mywishlist" target="_blank">{l s='click here' mod='baproductscarousel'}</a>{/addJsDefL}
