...
class Ziedslider extends Module {
	public function __construct() {
	    $this->name = 'ziedslider';
	    $this->tab = 'advertising_marketing';
	    $this->version = '1.0.0';
	    $this->author = 'BAGGA Zied';
	    ...
	    $this->displayName = $this->l('Zied Logo Slider');
	    $this->description = $this->l('This module add a gallery or slider with Brand Logos in your shop , .');
	...
	public function hookDisplayHeader() {	
		...
		$this->context->controller->addCSS($this->_path.'views/css/ziedslider.css');	

		$this->context->controller->addJS($this->_path.'views/js/jquery.flexisel.js'); 

		$this->context->controller->addJS($this->_path.'views/js/ziedslider.js'); 
