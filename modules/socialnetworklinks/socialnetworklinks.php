...
class socialnetworklinks extends Module
{
    ...
    function install()
    {
        if (parent::install() == false OR
            ...
            $this->registerHook('displayNav1') == false OR
            $this->registerHook('displayNav2') == false OR
    ...
    function hookdisplayNav1($params)
    {
        if (Configuration::get('snl_where') == 5) {
            $this->context->smarty->assign(array('snlvar' => $this->getvar()));
            return $this->display(__FILE__, 'views/front/column.tpl');
        }
    }

    function hookdisplayNav2($params)
    {
        if (Configuration::get('snl_where') == 6) {
            $this->context->smarty->assign(array('snlvar' => $this->getvar()));
            return $this->display(__FILE__, 'views/front/column.tpl');
        }
    }
